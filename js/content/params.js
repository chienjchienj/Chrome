var Params = {
  IMAGE_TEXT : '{image}',
  DEFAULT_COLUMN_NAME : 'Enter Field Name',
  ...
  NOTIFICATION_TITLE_IDLE : 'Click on <b>Add New</b> to begin.',
  ...
  NOTIFICATION_TITLE_ENTER_COLUMN_NAME : 'Give this field a name',
  NOTIFICATION_MESSAGE_ENTER_COLUMN_NAME : '',

  // TO REFACTOR OUT OF SYSTEM
  NOTIFICATION_TITLE_SAVE_COLUMN_FAILED : 'Current field is empty',
  NOTIFICATION_MESSAGE_SAVE_COLUMN_FAILED : 'Please ensure the item selection is completed before saving the column',
  // END
  
  // TO REFACTOR OUT OF SYSTEM
  NOTIFICATION_TITLE_NO_COLUMN_FAILED : 'No fields added yet',
