var Params = {
  ...
  NOTIFICATION_TITLE_PRE_SELECTION_1 : 'Click on items to include',
  ...
  NOTIFICATION_TITLE_ACTIVATE_NEXT_PAGER : 'Are there more simillar pages?',
  NOTIFICATION_MESSAGE_ACTIVATE_NEXT_PAGER : 'Usually a > or next button',  
  
  NOTIFICATION_TITLE_SELECT_NEXT_PAGER : 'Click link to the next page that is similar',
